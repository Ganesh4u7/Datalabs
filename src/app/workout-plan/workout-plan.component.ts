  ...
  onSearch(search) {
    ...
    if(this.searchText != undefined){
      if (this.lastSelectedItemName == 'sports') {
        ...
        filtered = this.sports.filter((str) => {
        ...
        filtered = this.houseWorks.filter((str) => {
          if (str.name.toLowerCase().includes(PATTERN)) {
            return str;
          }
        ...
        filtered = this.endurance.filter((str) => {
          if (str.name.toLowerCase().includes(PATTERN)) {
            return str;
          }
        ...
        filtered = this.strength.filter((str) => {
          if (str.name.toLowerCase().includes(PATTERN)) {
            return str;
          }
        ...
        filtered = this.conditioning.filter((str) => {
          if (str.name.toLowerCase().includes(PATTERN)) {
            return str;
          }
        ...
        filtered = this.flexibility.filter((str) => {
          if (str.name.toLowerCase().includes(PATTERN)) {
            return str;
          }
