...
export class CreatePlanComponent implements OnInit {
  ...
  onSearch(search) {
    var PATTERN = search, filtered;
    if(this.searchText != undefined){
      if (this.lastSelectedItemName == 'vegetables') {

      filtered = this.vegetables.filter((str) => {
      ...
      this.selectedItemType=filtered;
      this.cd.detectChanges()
    }
    else if (this.lastSelectedItemName == 'fruits') {

      filtered = this.fruits.filter((str) => {
        if (str.name.toLowerCase().includes(PATTERN)) {
          return str;
        }
      ...
      filtered = this.liquids.filter((str) => {
        if (str.name.toLowerCase().includes(PATTERN)) {
          return str;
        }
      ...
      filtered = this.seeds.filter((str) => {
        if (str.name.toLowerCase().includes(PATTERN)) {
          return str;
        }
      ...
      filtered = this.others.filter((str) => {
        if (str.name.toLowerCase().includes(PATTERN)) {
          return str;
        }
